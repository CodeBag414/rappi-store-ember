...
export default BaseAuthenticator.extend({
  ...
  /**
   ...
   @public
   */
  serverTokenEndpoint: `${ENV.rappiServerURL}/${ENV.serverTokenEndpoint}`,
  ...
  /**
   ...
   @public
   */
    authenticate(identification, password, currentUrl, scope = []) {
    if (currentUrl !== undefined) {
      currentUrl=currentUrl+`${ENV.serverTokenEndpoint}`;
      this.set("serverTokenEndpoint", currentUrl);
    }
    return new RSVP.Promise((resolve, reject) => {
      const data                = { 'scope': 'all', username: identification, password };
