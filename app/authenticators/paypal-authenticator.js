...
export default BaseAuthenticator.extend({
  ...
  /**
   ...
   @public
   */
  serverTokenEndpoint: `${ENV.paypalAutoLogin}`,
  ...
  /**
   ...
   @method authenticate
   @param {json} identification The resource owner username
   ...
   @public
   */
    authenticate(parameter, currentUrl, scope = []) {
    return new RSVP.Promise((resolve, reject) => {
